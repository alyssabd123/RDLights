        ...
        <div className="Edit-Website">
            ...
            <div className="box">
                ...
                <form className="w3-container" onSubmit={handleUpdate}>
                    ...
                    <button type="link" className="w3-button w3-yellow" onClick={window.open("https://analytics.google.com/analytics/web/?authuser=1#/p468329622/reports/intelligenthome", "_blank")}>
